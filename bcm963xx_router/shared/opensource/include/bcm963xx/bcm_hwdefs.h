...
#if  defined(_BCM96838_) || defined(_BCM963138_) || defined(_BCM963148_) || defined(_BCM96848_) || defined(AEI_63138_CHIP)
...
#elif defined(SUPPORT_GPL_1) && ( defined(_BCM963138_) || defined(CONFIG_BCM963138) )
typedef struct
{
    unsigned int ulVersion;
    char szBootline[NVRAM_BOOTLINE_LEN];
