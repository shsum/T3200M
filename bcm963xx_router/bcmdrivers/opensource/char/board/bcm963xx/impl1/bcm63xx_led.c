...
#if defined(SUPPORT_GPL_1)
#if !defined(SUPPORT_GPL_4) && !defined(AEI_63168_CHIP)
...
int __init bcmsysfsleds_init(void)
{
	...
	int index=0, token=0, rc;
        ...
        for(;;) {
                ledName=NULL;
#if defined(AEI_63138_CHIP)
#if defined(SUPPORT_GPL_4) || defined(NOT_USED_6)
...
void aei_set_internet_led_brightness(unsigned int brightness)
{
    ...
    if (BpGetInternetRedLedGpio( &gpio_green ) == BP_SUCCESS &&
        BpGetInternetGreenLedGpio( &gpio_red ) == BP_SUCCESS)
    {
