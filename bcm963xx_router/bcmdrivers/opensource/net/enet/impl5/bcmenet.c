...
#if defined(AEI_SUPPORT_100M_ETH_RELINK)
...
#if defined(SUPPORT_GPL_1) && !defined(AEI_63168_CHIP)
...
#if defined(SUPPORT_GPL_1) && defined(BCM_ENET_CB_WAN_PORT_LNX_INTF_SUPPORT)
        {
           ETHERNET_CROSSBAR_INFO *cb_info = NULL;
...
#if defined(AEI_63138_CHIP) && defined(SUPPORT_GPL_1)// && defined(CONFIG_BRCM_CHIP_VER_A0)
...
static void bcmenet_set_eth_sfp_led(int speed)
{
    if ( speed == 1000 )
    {
...
void link_change_handler(int port, int cb_port, int linkstatus, int speed, int duplex)
{
    ...
    int linkMask;
    int sw_port;
#if defined(CONFIG_BCM_SWITCH_PORT_TRUNK_SUPPORT) && defined(SUPPORT_GPL_1)
...
-------------------------------------------------------------------------- */
#if defined(AEI_LOAD_BALANCING_CONTROL)
...
#if defined(AEI_QTN_RGMII_RELOAD)
...
#if defined(SUPPORT_GPL_1) && !defined(AEI_63168_CHIP) && !defined(AEI_63138_CHIP)
...
#if defined(SUPPORT_GPL_1) && defined(CONFIG_BCM96368)
    {
        uint16 v16;
        ...
        case SIOCETHCTLOPS:
            switch(ethctl->op) {
                ...
                case ETHSETMIIREG:       /* Write MII PHY register. */
                    ...
                    break;
#if defined(AEI_VDSL_WAN_CONVERT_LAN)
