...
#if defined(AEI_VDSL_CUSTOMER_DHCP_OPTION120) || defined(NOT_USED_12)
 ...
 *   
 * Description: For XXXXX, if LAN Device is STB and hostname is NULL, we will set STB Default 
