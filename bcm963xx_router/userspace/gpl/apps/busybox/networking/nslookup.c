...
#if defined(AEI_VDSL_SMARTLED) || defined (NOT_USED_2)
#include "cms_msg.h"
#include "cms_log.h"
...
#if defined(NOT_USED_24) || defined(NOT_USED_2)
...
int nslookup_main(int argc, char **argv)
{
	...
	*/
	...
	if (host) {
#if defined (NOT_USED_2)	    
	    if(!strcmp(argv[1], "www.microsoft.com")||!strcmp(argv[1], "www.google.ca")||!strcmp(argv[1], "www.XXXXXXXXXX.net"))
