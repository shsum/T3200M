...
typedef struct
{
    ...
    UINT32    staticMaxFailure;	/**< StaticMaxFailure */
    ...
    UINT32    dynamicMaxFailure;	/**< DynamicMaxFailure */
    ...
    UINT32    deviceSteerStaticMaxFailure;	/**< DeviceSteerStaticMaxFailure */
    ...
    UINT32    deviceSteerDynamicMaxFailure;	/**< DeviceSteerDynamicMaxFailure */
 ...
 *
 * MDMOID_IGD_DEV2_WIFI_ASSOCIATED_DEVICE 4807
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_IGD_DEV2_WIFI_ASSOCIATED_DEVICE_STATS 4808
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
